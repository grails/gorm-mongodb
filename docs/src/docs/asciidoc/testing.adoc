...
[source,groovy]
----
include::{sourcedir}/examples/grails31-mongodb/src/test/groovy/functional/tests/LocalMongoUnitSpec.groovy[tags=structure]
----
...
[source,groovy]
----
include::{sourcedir}/examples/grails31-hibernate4-mongodb/src/test/groovy/functional/tests/BookFongoSpec.groovy[tags=getDomainClasses,indent=0]
----
